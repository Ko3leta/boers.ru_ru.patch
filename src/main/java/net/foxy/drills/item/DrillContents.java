...
public final class DrillContents implements TooltipComponent {
    public static final DrillContents EMPTY = new DrillContents(ItemStack.EMPTY);
    public static final Codec<DrillContents> CODEC = ItemStack.CODEC.xmap(DrillContents::new, p_331551_ -> p_331551_.items);
    public static final StreamCodec<RegistryFriendlyByteBuf, DrillContents> STREAM_CODEC = ItemStack.STREAM_CODEC
        .map(DrillContents::new, p_331649_ -> p_331649_.items);
    private static final Fraction BUNDLE_IN_BUNDLE_WEIGHT = Fraction.getFraction(1, 16);
    private static final int NO_STACK_INDEX = -1;
    final ItemStack items;

    public DrillContents(ItemStack items) {
        this.items = items;
    }
    ...
    public boolean equals(Object other) {
        if (this == other) {
            ...
            return !(other instanceof DrillContents bundlecontents)
                ? false
    ...
    public static class Mutable {
        ...
        public Mutable(DrillContents contents) {
        ...
        public DrillContents toImmutable() {
            return new DrillContents(this.items);
        }
    }
}
